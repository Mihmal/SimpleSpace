public class Ship {
  public const double drawMass;
  public double fuelMass;
  public const double maxFuelMass;
  public double fuelConsumption;
  public const double maxFuelConsumption;
  public const double fuelSpeed;
  ...
  public string name
  private double mass//Две "s" по-приколу написал
  public Vector2 velocity
  ...
  void CalcThrust () {
    additionalVelocity = fuelConsumption*fuelSpeed*Time.deltaTime/mass
    velocity.x += additionalVelocity*Math.cos(angle)
    velocity.y += additionalVelocity*Math.sin(angle)
  }
  
  void FixedUpdate () {
    mass = drawMass+fuelMass
    calcX();
    calcY();
    calcThrust();
